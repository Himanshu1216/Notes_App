import {Navbar, Nav, NavDropdown, Container, Form, Col, Row, Button} from 'react-bootstrap';
import './Header.css'
...
function Header() {
  return (
    <Navbar bg='primary' expand="lg" className="bg-body-tertiary py-3" variant='dark'>
      <Container>
        <Navbar.Brand href="/" style={{fontSize: '1.4rem'}}>Note Cloud</Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="me-auto">
            <Nav.Link href="#home" className='mx-2' style={{fontSize: '1.1rem'}}>My notes</Nav.Link>
